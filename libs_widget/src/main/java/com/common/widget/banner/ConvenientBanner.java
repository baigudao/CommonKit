...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
        ...
        layoutParams.setMargins(0, 0, AutoUtils.getPercentHeightSize(10), AutoUtils.getPercentHeightSize(58));
    ...
    public ConvenientBanner setPageIndicatorMarginBottom(int marginBottom) {
        MarginLayoutParams lp = (MarginLayoutParams) loPageTurningPoint.getLayoutParams();
        lp.bottomMargin = marginBottom;
        loPageTurningPoint.setLayoutParams(lp);
        return this;
    }
     ...
     */
    public ConvenientBanner setOnSimpleItemClickListener(OnItemClickListener onItemClickListener) {
        if (onItemClickListener == null) {
            viewPager.setOnSimpleItemClickListener(null);
            return this;
        }
        viewPager.setOnSimpleItemClickListener(onItemClickListener);
        return this;
    }

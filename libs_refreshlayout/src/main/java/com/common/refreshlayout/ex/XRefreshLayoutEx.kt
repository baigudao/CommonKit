 ...
 */
public inline fun XRefreshLayout.setLinearLayoutManager(
    context: Context,
 ...
 * @param pageSize   一页最多显示几条
 */
public inline fun XRefreshLayout.setStaggeredGridLayoutManager(
    context: Context,
    span: Int,
    pagerSize: Int = 20
) {
 ...
 * @param pageSize   一页最多显示几条
 */
public inline fun XRefreshLayout.setGridLayoutManager(
    context: Context,
    span: Int,
    pagerSize: Int = 20
) {

...
package com.common.main.swipebacklayout;
...
public class ViewDragHelper {
     ...
     * {@link com.xm.compatible.swipebacklayout.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.xm.compatible.swipebacklayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system

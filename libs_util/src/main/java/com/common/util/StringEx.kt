 ...
 * 是否为数字
 */
inline fun String.isNumber(): Boolean {
...
/** 是否为double类型 */
inline fun String.isDouble(): Boolean {
    if (this.isEmpty()) {
        return false
    }
...
/** 是否为手机号码 */
inline fun String.isMobile(): Boolean {
 ...
 * 为身份张格式
 */
inline fun String.isIDCard(): Boolean {
 ...
 * 非身份张格式
 */
inline fun String.isNotIDCard(): Boolean {
 ...
 * 是否为密码
 */
inline fun String.isPassWord(): Boolean {
